...
/** Prefixo público atrás do Caddy (ex. /a1/). Definir no Docker: VITE_PUBLIC_BASE=/a1 */
...
/** URL que o browser usa (ex. https://localhost:8443). Obrigatório atrás do Caddy + TLS. */
...
/** WebSocket HMR atrás de Caddy + handle_path costuma falhar (loop "too many retries"). */
const disableHmr =
